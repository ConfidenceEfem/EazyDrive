...
const HirerKYCScreen = () => {
    ...
    const schema = yup.object().shape({
        ...
        telephone: yup.string().required("Input your contact"),
    ...
    const submit = handleSubmit(async (data)=>{
        ...
        formData.append("hirerImage", imageLink)
        ...
        const res = await axios.post(`/api/user/kyc/${currentUserId}`, formData, config)
        if(res){
            setLoading(false)
            Swal.fire({
                position: 'center',
  ...
  return (
    <Container>
       ...
       <TitleAndSub>
            ...
            <Sub>
                This verification is mandatory for all car hirers.
                 Without verifying your account you 
                will not be able to <br/> hire a car
            </Sub>
        </TitleAndSub>
        <ImageUpload>
            {
